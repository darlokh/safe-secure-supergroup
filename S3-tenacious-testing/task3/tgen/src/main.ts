...
define First_Vector : Vectors.Vector := (X => 1.0, Y => 2.0, Z => 3.0);
...
define First_Vector : Vectors.Vector := (X => 1.0, Y => 0.0, Z => 0.0);
...
define First_Vector : Vectors.Vector := (X => 1.0, Y => 2.0, Z => 2.0);
