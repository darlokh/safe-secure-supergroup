...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#cf0a0a9a#;
   ...
   u00106 : constant Version_32 := 16#11329e00#;
   pragma Export (C, u00106, "ada_containersS");
   u00107 : constant Version_32 := 16#3834a2e7#;
   pragma Export (C, u00107, "ada_containers__aunit_listsB");
   u00108 : constant Version_32 := 16#c8d9569a#;
   pragma Export (C, u00108, "ada_containers__aunit_listsS");
   u00109 : constant Version_32 := 16#9b1c7ff2#;
   pragma Export (C, u00109, "aunit__memory__utilsB");
   u00110 : constant Version_32 := 16#fb2f6c57#;
   pragma Export (C, u00110, "aunit__memory__utilsS");
   u00111 : constant Version_32 := 16#01adf261#;
   pragma Export (C, u00111, "aunit__test_resultsB");
   u00112 : constant Version_32 := 16#1087836e#;
   pragma Export (C, u00112, "aunit__test_resultsS");
   u00113 : constant Version_32 := 16#9df5edcf#;
   pragma Export (C, u00113, "aunit__time_measureB");
   u00114 : constant Version_32 := 16#f32b0de9#;
   pragma Export (C, u00114, "aunit__time_measureS");
   u00115 : constant Version_32 := 16#c5dcd3d2#;
   pragma Export (C, u00115, "ada__calendarB");
   u00116 : constant Version_32 := 16#12a38fcc#;
   pragma Export (C, u00116, "ada__calendarS");
   u00117 : constant Version_32 := 16#a99e1d66#;
   pragma Export (C, u00117, "system__os_primitivesB");
   u00118 : constant Version_32 := 16#a72a814e#;
   pragma Export (C, u00118, "system__os_primitivesS");
   u00119 : constant Version_32 := 16#b6166bc6#;
   pragma Export (C, u00119, "system__task_lockB");
   u00120 : constant Version_32 := 16#4c2fa756#;
   ...
   u00122 : constant Version_32 := 16#6b6cea8f#;
   pragma Export (C, u00122, "aunit__testsS");
   u00123 : constant Version_32 := 16#6abe5dbe#;
   pragma Export (C, u00123, "system__finalization_mastersB");
   u00124 : constant Version_32 := 16#7659a9f2#;
   ...
   u00126 : constant Version_32 := 16#d87ce1d3#;
   ...
   u00129 : constant Version_32 := 16#6257e3a8#;
   ...
   u00131 : constant Version_32 := 16#0e480e95#;
   pragma Export (C, u00131, "system__storage_poolsS");
   u00132 : constant Version_32 := 16#5a895de2#;
   pragma Export (C, u00132, "system__pool_globalB");
   u00133 : constant Version_32 := 16#7141203e#;
   pragma Export (C, u00133, "system__pool_globalS");
   u00134 : constant Version_32 := 16#ee101ba4#;
   pragma Export (C, u00134, "system__memoryB");
   u00135 : constant Version_32 := 16#74d8f60c#;
   pragma Export (C, u00135, "system__memoryS");
   u00136 : constant Version_32 := 16#fd2ad2f1#;
   pragma Export (C, u00136, "gnatS");
   u00137 : constant Version_32 := 16#d43725a0#;
   pragma Export (C, u00137, "gnat__source_infoS");
   u00138 : constant Version_32 := 16#acb182ec#;
   pragma Export (C, u00138, "gnat__tracebackB");
   u00139 : constant Version_32 := 16#0701f3ba#;
   pragma Export (C, u00139, "gnat__tracebackS");
   u00140 : constant Version_32 := 16#85b06f15#;
   pragma Export (C, u00140, "gnat__traceback__symbolicS");
   u00141 : constant Version_32 := 16#9a578b55#;
   pragma Export (C, u00141, "aunit__reporter__textB");
   u00142 : constant Version_32 := 16#28ca7b1a#;
   pragma Export (C, u00142, "aunit__reporter__textS");
   u00143 : constant Version_32 := 16#b48102f5#;
   pragma Export (C, u00143, "gnat__ioB");
   u00144 : constant Version_32 := 16#6227e843#;
   pragma Export (C, u00144, "gnat__ioS");
   u00145 : constant Version_32 := 16#b602a99c#;
   pragma Export (C, u00145, "system__exn_intB");
   u00146 : constant Version_32 := 16#6f298c64#;
   pragma Export (C, u00146, "system__exn_intS");
   u00147 : constant Version_32 := 16#f4e1c091#;
   pragma Export (C, u00147, "system__stream_attributesB");
   u00148 : constant Version_32 := 16#8bc30a4e#;
   ...
   u00153 : constant Version_32 := 16#6d4327a3#;
   pragma Export (C, u00153, "vectors_suiteB");
   u00154 : constant Version_32 := 16#a260389e#;
   pragma Export (C, u00154, "vectors_suiteS");
   u00155 : constant Version_32 := 16#207ceced#;
   pragma Export (C, u00155, "vectors_testB");
   u00156 : constant Version_32 := 16#3ecd8ae7#;
   pragma Export (C, u00156, "vectors_testS");
   u00157 : constant Version_32 := 16#84ad4a42#;
   pragma Export (C, u00157, "ada__numericsS");
   u00158 : constant Version_32 := 16#03e83d1c#;
   pragma Export (C, u00158, "ada__numerics__elementary_functionsB");
   u00159 : constant Version_32 := 16#00443200#;
   pragma Export (C, u00159, "ada__numerics__elementary_functionsS");
   u00160 : constant Version_32 := 16#3e0cf54d#;
   pragma Export (C, u00160, "ada__numerics__auxB");
   u00161 : constant Version_32 := 16#9f6e24ed#;
   pragma Export (C, u00161, "ada__numerics__auxS");
   u00162 : constant Version_32 := 16#29322bcb#;
   pragma Export (C, u00162, "system__fat_llfS");
   u00163 : constant Version_32 := 16#221eebf6#;
   pragma Export (C, u00163, "system__machine_codeS");
   u00164 : constant Version_32 := 16#6c05c057#;
   pragma Export (C, u00164, "system__exn_llfB");
   u00165 : constant Version_32 := 16#91db2be4#;
   pragma Export (C, u00165, "system__exn_llfS");
   u00166 : constant Version_32 := 16#75d08c2c#;
   pragma Export (C, u00166, "system__fat_fltS");
   u00167 : constant Version_32 := 16#1fadf3e3#;
   pragma Export (C, u00167, "vectorsB");
   u00168 : constant Version_32 := 16#7a039cec#;
   pragma Export (C, u00168, "vectorsS");
   u00169 : constant Version_32 := 16#e18a47a0#;
   pragma Export (C, u00169, "ada__float_text_ioB");
   u00170 : constant Version_32 := 16#e61b3c6c#;
   pragma Export (C, u00170, "ada__float_text_ioS");
   ...
   u00180 : constant Version_32 := 16#d5f9759f#;
   pragma Export (C, u00180, "ada__text_io__float_auxB");
   u00181 : constant Version_32 := 16#f854caf5#;
   pragma Export (C, u00181, "ada__text_io__float_auxS");
   u00182 : constant Version_32 := 16#181dc502#;
   ...
   u00184 : constant Version_32 := 16#8aa4f090#;
   pragma Export (C, u00184, "system__img_realB");
   u00185 : constant Version_32 := 16#ea0dc1da#;
   pragma Export (C, u00185, "system__img_realS");
   u00186 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00186, "system__float_controlB");
   u00187 : constant Version_32 := 16#cd59d304#;
   pragma Export (C, u00187, "system__float_controlS");
   u00188 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00188, "system__img_lluB");
   u00189 : constant Version_32 := 16#50eaec78#;
   pragma Export (C, u00189, "system__img_lluS");
   u00190 : constant Version_32 := 16#7dd5f64f#;
   pragma Export (C, u00190, "system__powten_tableS");
   u00191 : constant Version_32 := 16#faa9a7b2#;
   pragma Export (C, u00191, "system__val_realB");
   u00192 : constant Version_32 := 16#d38ce729#;
   pragma Export (C, u00192, "system__val_realS");
   u00193 : constant Version_32 := 16#f9b5bb0c#;
   pragma Export (C, u00193, "aunit__test_casesB");
   u00194 : constant Version_32 := 16#b9f05298#;
   pragma Export (C, u00194, "aunit__test_casesS");
